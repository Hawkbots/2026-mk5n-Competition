...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(50).withKI(0).withKD(0) //kP default is 20
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(6); //does nothing apparently, tune max speed in robot container
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.46484375);
